...
class MyProtocolTransport(StackingTransport):
    ...
    def mvwindow(self, n):
        ...
        while len(self.to_send) < 5 and len(self.my_protocol_packets) > 0:
            ...
            print("PLS: Sending PLS packet.", pkt.to_string())
        ...
        while self.state < 6:
            ...
            if self.counter <= 0:
                ...
                if len(self.to_send) == 1 and self.to_send[0].Type == 3:
                    ...
                    print("PLS: Sending PLS packet.", self.to_send[0].to_string())
                    print("the packet it sends is RIP")
                    ...
                    for i in range(0, len(self.to_send)):
                        ...
                        print("PLS: Sending PLS packet.", self.to_send[i].to_string())
                self.counter = 0.3
            else:
